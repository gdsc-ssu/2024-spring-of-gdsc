...
import com.example.urlshortener.domain.url.repository.ShortenedUrlQureyRepository;
...
public class UrlService {
    ...
    private final ShortenedUrlQureyRepository shortenedUrlQueryRepository;
    ...
    public List<ShortenedUrlDto> getShortUrlQureyDsl(String inquiry) {
